 ...
 */
   private static void processFile(String iFile) {
      ...
      Stack <Vertex> topologicalStack = new Stack <Vertex>();
     ArrayList <Vertex> vertexesList = new ArrayList <Vertex>();
      ...
      try {
        ...
        */
        ...
        H_DFS.NDFS(vertexStack, reverseStack, topologicalStack, vertexesList.get(0), vertexesList);
    ...
    * @param vertList
    */
   public static void SCC(Stack <Vertex> revStack) {
